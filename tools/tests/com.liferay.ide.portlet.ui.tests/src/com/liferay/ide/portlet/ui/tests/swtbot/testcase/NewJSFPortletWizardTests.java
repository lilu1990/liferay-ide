...
public class NewJSFPortletWizardTests extends SWTBotBase implements JSFPortletWizard, WizardBase
{
    ...
    public static void createJSFPortletProject() throws Exception
    {
        ...
        for( int i = 0; i < shells.length; i++ )
        {
            ...
            System.out.println( shells[i].getText() + shells[i].isActive() );
            System.out.println( shells[i].getText() + shells[i].isEnabled() );
            System.out.println( shells[i].getText() + shells[i].isOpen() );
            System.out.println( shells[i].getText() + shells[i].isVisible() );
        }
